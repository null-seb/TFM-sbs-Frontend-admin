  ...
  <div class="app-container">
    ...
    <div class="ccInfo">
      ...
      <div class="main">
        ...
        <p><span>Subject:{{ coursePublish.subjectParentTitle }} — {{ coursePublish.subjectTitle }}</span></p>
        <p>College：{{ coursePublish.collegeName }}</p>
    ...
    <div style="text-align:center">
      ...
      <el-button :disabled="publishBtnDisabled" type="primary" @click="publish()">Publish Courses</el-button>
    </div>
  </div>
</template>
