  ...
  <div class="app-container">
    ...
    <div style="margin-bottom: 10px">
      <router-link to="/ad/type-create">
        <el-button type="primary" size="mini" icon="el-icon-edit">Create AdType</el-button>
      </router-link>
    </div>
    ...
    <el-table :data="list" border stripe>
      ...
      <el-table-column prop="title" label="AdType Name" />
...
export default {
  ...
  methods: {
    ...
    // 根据id删除数据
    removeById(id) {
      this.$confirm('Do you want to delete this record?', 'Tips', {
